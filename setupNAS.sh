...
set +x
echo ""
#cho "# If this is the first time this script is run please Control-C now and Reboot !!!"
#echo "# If this is the first time this script is run please Control-C now and Reboot !!!"
#echo "# If this is the first time this script is run please Control-C now and Reboot !!!"
echo "#"
echo "# Please REMOVE the USB3 disk cables from the Pi, wait 5 seconds, then re-connect them into the same USB3 slots !"
echo "# Please REMOVE the USB3 disk cables from the Pi, wait 5 seconds, then re-connect them into the same USB3 slots !"
echo "# Please REMOVE the USB3 disk cables from the Pi, wait 5 seconds, then re-connect them into the same USB3 slots !"
echo "# Please REMOVE the USB3 disk cables from the Pi, wait 5 seconds, then re-connect them into the same USB3 slots !"
echo "# Please REMOVE the USB3 disk cables from the Pi, wait 5 seconds, then re-connect them into the same USB3 slots !"
echo "#"
echo "# (So that the USB3 drive(s) get mounted with the correct mount points"
echo "#"
