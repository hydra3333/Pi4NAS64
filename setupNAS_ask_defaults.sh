...
echo "server_alias=${server_alias}">> "$setup_config_file"
echo "server_alias_default=${server_alias}">> "$setup_config_file"
#
echo "server_root_USBmountpoint=${server_root_USBmountpoint}">> "$setup_config_file"
echo "server_root_USBmountpoint_default=${server_root_USBmountpoint}">> "$setup_config_file"
echo "server_root_folder=${server_root_folder}">> "$setup_config_file"
...
echo "server_root_USBmountpoint2=${server_root_USBmountpoint2}">> "$setup_config_file"
echo "server_root_USBmountpoint2_default=${server_root_USBmountpoint2}">> "$setup_config_file"
echo "server_root_folder2=${server_root_folder2}">> "$setup_config_file"
