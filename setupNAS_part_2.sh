...
#touch "./tmp_sed_input.txt"
## for my medialibrary1 on FIRST USB3 drive
#echo "media_dir=PVA,${root_folder_1}/2015.11.29-Jess-21st-birthday-party">>"./tmp_sed_input.txt"
#echo "media_dir=PVA,${root_folder_1}/BigIdeas">>"./tmp_sed_input.txt"
#echo "media_dir=PVA,${root_folder_1}/CharlieWalsh">>"./tmp_sed_input.txt"
#echo "media_dir=PVA,${root_folder_1}/ClassicDocumentaries">>"./tmp_sed_input.txt"
#echo "media_dir=PVA,${root_folder_1}/ClassicMovies">>"./tmp_sed_input.txt"
#echo "media_dir=PVA,${root_folder_1}/Documentaries">>"./tmp_sed_input.txt"
#echo "media_dir=PVA,${root_folder_1}/movies">>"./tmp_sed_input.txt"
#echo "media_dir=PVA,${root_folder_1}/OldMovies">>"./tmp_sed_input.txt"
#echo "media_dir=PVA,${root_folder_1}/OldSciFi">>"./tmp_sed_input.txt"
#echo "media_dir=PVA,${root_folder_1}/SciFi">>"./tmp_sed_input.txt"
## for in medialibrary2 on SECOND USB3 drive
#echo "media_dir=PVA,${root_folder_2}/Footy">>"./tmp_sed_input.txt"
#echo "media_dir=PVA,${root_folder_2}/MusicVideos">>"./tmp_sed_input.txt"
...
#sudo rm -vf "./tmp_sed_input.txt"
# SO TRY THIS INSTEAD: insert in reverse order.
...
sudo sed -i "s;#zzz---zzz;#zzz---zzz\n## for in medialibrary2 on SECOND USB3 drive;g" "/etc/minidlna.conf"
...
sudo sed -i "s;#zzz---zzz;#zzz---zzz\n## for in medialibrary1 on FIRST USB3 drive;g" "/etc/minidlna.conf"
#
