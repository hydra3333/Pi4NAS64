...
#echo "# If this is the first time this script is run please Control-C now and Reboot !!!"
echo "#"
echo "# IF THIS IS THE FIRST TIME RUNNING THIS SCRIPT ON THIS PI, PLEASE RFEBOOT NOW AND RESTART THE SCRIPT"
echo "# IF THIS IS THE FIRST TIME RUNNING THIS SCRIPT ON THIS PI, PLEASE RFEBOOT NOW AND RESTART THE SCRIPT"
echo "# IF THIS IS THE FIRST TIME RUNNING THIS SCRIPT ON THIS PI, PLEASE RFEBOOT NOW AND RESTART THE SCRIPT"
echo "# IF THIS IS THE FIRST TIME RUNNING THIS SCRIPT ON THIS PI, PLEASE RFEBOOT NOW AND RESTART THE SCRIPT"
echo "# IF THIS IS THE FIRST TIME RUNNING THIS SCRIPT ON THIS PI, PLEASE RFEBOOT NOW AND RESTART THE SCRIPT"
...
echo "# IF THIS IS THE FIRST TIME RUNNING THIS SCRIPT ON THIS PI, PLEASE RFEBOOT NOW AND RESTART THE SCRIPT"
echo "#"
echo "# Otherwise just continue on."
echo "# Otherwise just continue on."
echo "#"
echo "#"
...
echo "#"
set -x
ls -al "${server_root_USBmountpoint}"
